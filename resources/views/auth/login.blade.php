                    ...
                    <div class="mt-12">
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div>
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" placeholder="mike@gmail.com" name="email" required>
