...
@section('content')
        ...
        <div class="lg:flex">
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="pt-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        ...
                        <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">PCSLaundry</div>
                    </div>
                </div>
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="flex">
                                <div>
                                    ...
                                    <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" placeholder="mike tyson" name="name" required>
                                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                </div>
                                <div>
                                    <div class="text-sm font-bold text-gray-700 tracking-wide">Telephone</div>
                                    <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="number" placeholder="021-xxx-xxxx" name="telephone" required>
                                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                </div>
                            </div>
                            <div class="mt-8">
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" placeholder="mike@tyson.com" name="email" required>
                            ...
                            <div class="mt-8">
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Enter your password confirmation" name="password_confirmation" required>
